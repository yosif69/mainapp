const Images = {
    ...
    pants1: () => require ('./pants1.webp'),
    pants2: () => require ('./pants2.webp'),
    pants3: () => require ('./pants3.webp'),
    pants4: () => require ('./pants4.webp'),
